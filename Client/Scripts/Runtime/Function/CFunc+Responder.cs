...
public static partial class CFunc {
	...
	/** 드래그 응답자를 설정한다 */
	public static void SetupDragResponders<K>(List<(K, string, GameObject, GameObject)> a_oKeyInfoList, Vector3 a_stSize, Dictionary<K, GameObject> a_oOutObjDict, bool a_bIsEnableAssert = true) {
		CAccess.Assert(!a_bIsEnableAssert || (a_oKeyInfoList.ExIsValid() && a_oOutObjDict != null));
